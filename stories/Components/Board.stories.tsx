...
const meta: Meta<typeof Board> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'Main Scrum Board component with full drag-and-drop functionality.',
            },
        },
    },
};
        ...
        withStore({
            board: {
                columns: [
                    ...
                    { id: 'in-progress', title: 'In Progress', columnType: 'default', taskIds: [] },
                ],
                tasks: {
...
export const DnDBoard: Story = {
    ...
    decorators: [
        withStore({
            board: {
                columns: [
                    { id: 'todo', title: 'To Do', columnType: 'default', taskIds: ['1', '2'] },
                    { id: 'in-progress', title: 'In Progress', columnType: 'default', taskIds: ['3'] },
